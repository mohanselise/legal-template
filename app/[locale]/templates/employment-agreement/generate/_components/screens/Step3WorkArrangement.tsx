...
export function Step3WorkArrangement() {
  const t = useTranslations('employmentAgreement.step3Work');
    ...
    <div className="space-y-6">
      ...
      <div className="space-y-5">
        <SmartInput
          ...
          placeholder={
            formData.workArrangement === 'remote'
              ? t('homeBasePlaceholder')
              : t('officeLocationPlaceholder')
          }
          ...
          helpText={
            formData.workArrangement === 'remote'
              ? t('homeBaseHelp')
              : formData.workArrangement === 'hybrid'
              ? t('officeLocationHelp')
              : t('primaryWorkLocationHelp')
          }
          suggestion={
            enrichment.jurisdictionData?.city && formData.workArrangement !== 'remote'
              ? {
                  ...
                  reason: t('basedOnCompanyAddress'),
                  confidence: 'high',
                  source: 'jurisdiction',
                }
              : undefined
        ...
        <SmartInput
          ...
          placeholder="40"
          required
          helpText={t('hoursPerWeekHelp')}
          suggestion={
            marketStandards
              ? {
                  value: marketStandards.workHoursPerWeek.toString(),
                  reason: t('standardWorkWeek', { jurisdiction: jurisdictionName }),
                  confidence: 'high',
                  source: 'jurisdiction',
                }
              : undefined
        ...
        {marketStandards && (
          <Collapsible open={isCustomScheduleOpen} onOpenChange={setIsCustomScheduleOpen}>
            <CollapsibleTrigger asChild>
              ...
              >
                {t('typicalWorkWeek', { workDays: marketStandards.workDays })}
