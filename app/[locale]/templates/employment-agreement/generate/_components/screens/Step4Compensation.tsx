...
export function Step4Compensation() {
  const t = useTranslations('employmentAgreement.step4');
  ...
  const PAY_FREQUENCY_OPTIONS: Array<{ value: PayFrequency; label: string; regions: string[] }> = [
    { value: 'hourly', label: t('hourly'), regions: ['US'] },
    { value: 'weekly', label: t('weekly'), regions: ['US'] },
    { value: 'bi-weekly', label: t('biWeekly'), regions: ['US', 'CA'] },
    { value: 'monthly', label: t('monthly'), regions: ['GB', 'CH', 'DE', 'FR'] },
    { value: 'annual', label: t('annual'), regions: ['all'] },
  ];
          ...
          <div className="flex items-start gap-3">
            ...
            <div className="flex-1">
              ...
              <div className="grid grid-cols-3 gap-3 text-xs">
                <div>
                  <p className="text-[hsl(var(--brand-muted))]">{t('min')}</p>
                ...
                <div>
                  <p className="text-[hsl(var(--brand-muted))]">{t('median')}</p>
                  <p className="font-semibold text-[hsl(var(--fg))]">
                    {formData.salaryCurrency || jobTitleData.typicalSalaryRange.currency}
                    {' '}
                    {formatSalary(
                ...
                <div>
                  <p className="text-[hsl(var(--brand-muted))]">{t('max')}</p>
                  <p className="font-semibold text-[hsl(var(--fg))]">
                    {formData.salaryCurrency || jobTitleData.typicalSalaryRange.currency}
                    {' '}
                    {formatSalary(
              ...
              suggestion={
                enrichment.jurisdictionData
                  ? {
                      ...
                      reason: t('standardCurrencyIn', { jurisdiction: jurisdictionName }),
                      confidence: 'high',
                      source: 'jurisdiction',
                    }
                  : undefined
              ...
              return (
                ...
                >
                  {isRecommended && (
                    <Badge
                      variant="outline"
                      className="absolute -top-2.5 right-2 border-[hsl(var(--brand-primary))] bg-[hsl(var(--popover))] dark:bg-[hsl(var(--popover))] px-2 text-[10px] text-[hsl(var(--brand-primary))] shadow-lg font-medium backdrop-blur-sm"
                    >
                      {t('recommended')}
                    </Badge>
                  )}
