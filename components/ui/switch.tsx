...
>(({ className, ...props }, ref) => (
    <SwitchPrimitives.Root
        className={cn(
            ...
            "data-[state=checked]:bg-[hsl(var(--selise-blue))] data-[state=checked]:border-[hsl(var(--selise-blue))]",
            "data-[state=unchecked]:bg-[hsl(var(--muted))] data-[state=unchecked]:border-[hsl(var(--border))] data-[state=unchecked]:bg-opacity-100",
            className
        )}
        {...props}
        ref={ref}
